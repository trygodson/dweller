  ...
  const nocollectionAdded = () => {
    return (
      <div className="flex flex-col h-full justify-center items-center">
        <p className="text-base font-bold ">No Users added Yet</p>
        <img src={emptyicon} width="150" />
        <span className="text-sm text-grey-400">
          This shows expected Users for a particular community
        </span>
        <span className="text-sm text-indigo-800">Add at least one User</span>
      </div>
    );
  };
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-4">
          <div className="w-full shadow bg-white py-7 px-5 rounded-md">
            <div className="mb-5">
              <h3 className="font-serif text-xl">Create Community With Users</h3>
            </div>

            <div className="my-1">
              <InputField inputType="input" type="text" label={'Community Name'} placeholder="" />
            </div>
            <div className="my-1">
              <div className="my-1">
                <InputField inputType="select" label={'Community Type'} placeholder="">
                  <option>Open</option>
            ...
            <div className="flex justify-center">
              <Button2>Create Community</Button2>
            </div>
          </div>
        </div>
